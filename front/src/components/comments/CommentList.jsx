...
class CommentList extends React.PureComponent {
  ...
  editComment = (useThis, commentID) => {
    return function() {
      const comment = useThis.state.comments[commentID];
      if ( comment ) {
        useThis.setState({
          openModal: true,
          editId: commentID,
    ...
    while ( --reverseI >= 0 ) {
      ...
      list.push(
        <div key={ comment.id } className="card text-white bg-secondary mb-4 offset-4 col-4 d-flex justify-content-end" >
          <div>
            <div className="btn" onClick={ this.editComment(this, reverseI ) }>
            ...
            <div className="btn float-right" onClick={ this.removeComment(this, reverseI ) }>
